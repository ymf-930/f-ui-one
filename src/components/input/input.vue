<template>
  <div :class="wrapClasses">
    <template v-if="type !== 'textarea'">
      <span class="fei-input-group-prepend" v-if="$slots.prepend">
      ...
      <input
        ...
        @change="handleChange"
      />
      <span class="fei-input-prefix" v-if="showPrefix">
        <slot name="prefix">
          <i class="f-iconfont" :class="['f-icon-' + prefix]" v-if="prefix"></i>
        </slot>
      </span>
      <span class="fei-input-suffix" v-if="showSuffix">
        <i
          class="f-iconfont"
          :class="['f-icon-' + icon, 'fei-input-icon', 'fei-input-icon-normal']"
          v-if="icon"
        ...
        ></i>
        <slot name="suffix">
          <i class="f-iconfont" :class="['f-icon-' + suffix]" v-if="suffix"></i>
        </slot>
        <i v-if="FForm.statusIcon&&validateState" :class="['f-iconfont','fei-input__validateIcon', validateIcon]"></i>
      </span>
      <span class="fei-input-word-count" v-if="showWordCount">{{ wordCount }}</span>
      <!--清空按钮-->
      ...
      <span class="fei-input-group-append" v-if="$slots.append">
  ...
  setup(props, ctx) {
    ...
    const showSuffix = computed(() => {
        return props.suffix !== '' || props.icon !== '' || props.search || props.showPasswordToggle ||
          (FForm.statusIcon && validateState.value !== '') || ctx.slots.suffix !== undefined
      },
    )
