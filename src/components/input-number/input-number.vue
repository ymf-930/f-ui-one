<template>
  <div
    :class="[
      'fei-input-number',
      {
        [`fei-input-number-${inputSize}`]: !!inputSize,
        ['fei-input-number-disabled']: inputDisabled,
        ['fei-input-number-focused']: focused,
        ['fei-input-number-always']: always,
      },
    ]"
  >
    <template v-if="always">
      <a v-repeat-click="down" :class="minusClasses">
        <i class="f-iconfont f-icon-minus"></i>
      </a>
      <a v-repeat-click="up" :class="plusClasses">
        <i class="f-iconfont f-icon-plus"></i>
      </a>
    </template>
    <template v-else>
...
const prefixCls = 'fei-input-number'
...
export default {
  ...
  setup(props, ctx) {
    ...
    const inputSize = computed(() => props.size || FForm.size || FFormItem.size)
  ...
  computed: {
    ...
    innerUpClasses() {
      return `${prefixCls}-handler-up-inner f-iconfont f-icon-${this.arrowUpIcon}`
    },
    downClasses() {
      return [
        `${prefixCls}-handler`,
    ...
    innerDownClasses() {
      return `${prefixCls}-handler-down-inner f-iconfont f-icon-${this.arrowDownIcon}`
    },
    inputWrapClasses() {
