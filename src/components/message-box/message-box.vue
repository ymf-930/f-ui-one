    ...
    >
      <transition name="dialog-fade">
        <div
          ...
          aria-modal="true"
          :class="[ 'fei-message-box',customClass, ]"
        >
          <div
            v-if="title !== null && title !== undefined"
            class="fei-message-box__header"
          >
            <i v-if="icon"
               :class="['fei-message-box__status',`f-iconfont f-icon-${icon} is-${type}` ]"
            ></i>
            <div class="fei-message-box__title">
              <span>{{ title }}</span>
            </div>
          </div>
          <div v-if="hasMessage" class="fei-message-box__message">
            <slot>
              <p v-if="!useHTML">{{ message }}</p>
              <p v-else v-html="message"></p>
            </slot>
          </div>
          <div class="fei-message-box__footer">
            <f-button
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const confirmButtonClasses = computed(() => `f-button--primary ${props.confirmButtonClass}`)
