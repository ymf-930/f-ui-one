      ...
      >
        <transition :name="transitionName || 'dialog-fade'">
          <div
            ...
            @click.stop=""
          >
            <div class="fei-modal-close">
              <slot name="ctrl"></slot>
              <i v-if="showClose" class="f-iconfont f-icon-close" @click="handleClose"></i>
            </div>
            <div class="fei-modal-header" v-if="$slots.title || title">
              <slot name="title">
                <span class="fei-modal-title">
                  {{ title }}
                </span>
              </slot>
            </div>
            <template v-if="rendered">
              <div class="fei-modal-body" :style="bodyStyles">
                <slot></slot>
              </div>
            </template>
            <div v-if="$slots.footer" class="fei-modal-footer">
