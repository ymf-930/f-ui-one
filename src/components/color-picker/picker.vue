<template>
  ...
  >
      ...
      <div v-click-outside="hide">
        ...
        <div class="fei-color-dropdown__btns">
          ...
          <f-button
            size="mini"
            type="text"
            class="fei-color-dropdown__link-btn"
            @click="clear"
          >
            清空
          </f-button>
    ...
    <template #trigger>
      ...
      >
        <div v-if="colorDisabled" class="fei-color-picker__mask"></div>
        ...
        <div class="fei-color-picker__label" v-if="showLabel" @click="handleTrigger">
          {{ modelValue }}
        </div>
      </div>
    </template>
