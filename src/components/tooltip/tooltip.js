...
import FPopper, { defaultProps } from '../popper'
...
export default {
  ...
  setup(props, ctx) {
    ...
    if (props.manual && typeof props.modelValue === 'undefined') {
      throwError('[FTooltip]', 'You need to pass a v-model to f-tooltip when `manual` is true')
    }
  ...
  render() {
    ...
    const throwErrorTip = () => {
      throwError('[FTooltip]', 'you need to provide a valid default slot.')
    }
