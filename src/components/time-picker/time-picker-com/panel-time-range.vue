<template>
  <div v-if="actualVisible" class="fei-time-range-picker fei-picker-panel">
    <div class="fei-time-range-picker__content">
      <div class="fei-time-range-picker__cell">
        <div class="fei-time-range-picker__header">开始时间</div>
        <div
          :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
          class="fei-time-range-picker__body fei-time-panel__content"
        >
          <time-spinner
            ref="minSpinner"
            role="start"
      ...
      <div class="fei-time-range-picker__cell">
        <div class="fei-time-range-picker__header">结束时间</div>
        <div
          :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
          class="fei-time-range-picker__body fei-time-panel__content"
        >
    ...
    <div class="fei-time-panel__footer">
      <f-button
        type="text"
        size="mini"
        @click="handleCancel"
...
export default {
  ...
  components: { FButton, TimeSpinner },
