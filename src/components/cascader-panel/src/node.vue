<template>
  ...
  >
    ...
    <i v-else-if="isLeaf && node.checked" class="f-iconfont f-icon-check fei-cascader-node__prefix"></i>
    ...
    <template v-if="!isLeaf">
      <i v-if="node.loading" class="f-iconfont f-icon-loading icon-is-rotating fei-cascader-node__postfix"></i>
