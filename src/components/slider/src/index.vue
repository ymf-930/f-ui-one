<template>
  <div class="fei-slider-wrapper">
    <div
      ref="sliderWrapper"
      class="fei-slider"
      :class="{ 'is-vertical': vertical, 'fei-slider--with-input': showInput }"
      role="slider"
      :aria-valuemin="min"
      :aria-valuemax="max"
    ...
    >
      ...
      <div
        ref="slider"
        class="fei-slider__runway"
        :class="{ 'show-input': showInput, 'disabled': sliderDisabled }"
        :style="runwayStyle"
        @click="onSliderClick"
      >
        <div
          class="fei-slider__bar"
          :style="barStyle"
        >
        </div>
        <slider-button
        ...
        <template v-if="markList.length > 0">
          <div>
            <div
              ...
              class="fei-slider__stop fei-slider__marks-stop"
            >
            </div>
          </div>
          <div class="fei-slider__marks">
            <slider-marker
              v-for="(item, key) in markList"
              :key="key"
              :mark="item.mark"
