<template>
  ...
  >
    <div class="fei-carousel__container" :style="{ height: height }">
      <transition v-if="arrowDisplay" name="carousel-arrow-left">
        <button
          ...
          "
          type="button"
          class="fei-carousel__arrow fei-carousel__arrow--left"
      ...
      <transition v-if="arrowDisplay" name="carousel-arrow-right">
        <button
          ...
          "
          type="button"
          class="fei-carousel__arrow fei-carousel__arrow--right"
    ...
    <ul v-if="indicatorPosition !== 'none'" :class="indicatorsClasses">
      <li
        ...
        :key="index"
        :class="[
          'fei-carousel__indicator',
          'fei-carousel__indicator--' + direction,
          { 'is-active': index === data.activeIndex },
        ]"
        @mouseenter="throttledIndicatorHover(index)"
        @click.stop="handleIndicatorClick(index)"
      >
        <button class="fei-carousel__button">
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const carouselClasses = computed(() => {
      const classes = ['fei-carousel', 'fei-carousel--' + props.direction]
      if (props.type === 'card') {
        classes.push('fei-carousel--card')
      }
      return classes
    })
    ...
    const indicatorsClasses = computed(() => {
      const classes = [
        'fei-carousel__indicators',
        'fei-carousel__indicators--' + props.direction,
      ]
      if (hasLabel.value) {
        classes.push('fei-carousel__indicators--labels')
      }
      if (props.indicatorPosition === 'outside' || props.type === 'card') {
        classes.push('fei-carousel__indicators--outside')
      }
      return classes
    })
