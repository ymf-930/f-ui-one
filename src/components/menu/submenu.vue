  ...
  setup(props) {
    ...
    const isFirstLevel = computed(() => {
      ...
      while (parent && parent.type.name !== 'FMenu') {
        if (['FSubmenu', 'FMenuItemGroup'].includes(parent.type.name)) {
          isFirstLevel = false
          break
        } else {
    ...
    const handleMouseleave = (deepDispatch = false) => {
      ...
      if (appendToBody.value && deepDispatch) {
        if (instance.parent.type.name === 'FSubmenu') {
  ...
  render() {
    const titleTag = [
      ...
      h(
        'i',
        {
          class: ['fei-submenu__icon-arrow','f-iconfont', this.submenuTitleIcon],
        },
        null,
      ),
    ]
    ...
    const child = this.isMenuPopup
      ? h(
        FPopper,
        {
          ...
          boundariesPadding: 0,
          showArrow: false,
          popperClass: 'fei-submenu-popper',
                ...
                default: () =>
                  withDirectives(
                    h(
                      ...
                      {
                        ref: 'menu',
                        class: [`fei-menu--${this.mode}`, 'fei-submenu-popper'],
                        onMouseenter: ($event) =>
                      ...
                      [
                        h(
                          ...
                          {
                            class: [
                              'fei-menu fei-menu--popup',
                              `fei-menu--popup-${this.data.currentPlacement}`,
                            ],
                            style: ulStyle,
                          },
                          [this.$slots.default?.()],
            ...
            default: () =>
              withDirectives(
                h(
                  ...
                  {
                    role: 'menu',
                    class: 'fei-menu fei-menu--inline',
                    style: ulStyle,
                  },
                  [this.$slots.default?.()],
                ),
