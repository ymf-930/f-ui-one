<template>
  <div :class="classes" ref="cell">
    ...
    <template v-if="renderType === 'selection'">
      <f-checkbox :model-value="checked" @click.native.stop @change="toggleSelect"
                  :disabled="disabled"></f-checkbox>
    </template>
    ...
    <template v-if="renderType === 'normal'">
      <template v-if="column.tooltip &&tooltipTheme">
        <f-tooltip
          class="fei-table-cell-tooltip-content"
          append-to-body
          :theme="tooltipTheme"
        >
...
import FCheckbox from '../checkbox/checkbox'
import { inject, ref } from 'vue'
import FTooltip from '../tooltip'

export default {
  name: 'TableCell',
  components: { FTooltip, FCheckbox, TableExpand, TableSlot },
  props: {
    prefixCls: String,
    row: Object,
    column: Object,
