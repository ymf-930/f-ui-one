<template>
  <div
    class="fei-picker-panel fei-date-picker"
    :class="[{
  ...
  >
    <div class="fei-picker-panel__body-wrapper">
      ...
      <div class="fei-picker-panel__body">
        <div v-if="showTime" class="fei-date-picker__time-header">
          <span class="fei-date-picker__editor-wrap">
            <f-input
              placeholder="选择日期"
          ...
          <span
            ...
            class="fei-date-picker__editor-wrap"
          >
            <f-input
              placeholder="选择时间"
        ...
        <div
          ...
          class="fei-date-picker__header"
          :class="{ 'fei-date-picker__header--bordered': currentView === 'year' || currentView === 'month' }"
        >
          <button
            type="button"
            aria-label="上一年"
          ...
          <span
            role="button"
            class="fei-date-picker__header-label"
        ...
        <div class="fei-picker-panel__content">
          <date-table
    ...
    <div
      ...
      class="fei-picker-panel__footer"
    >
      <f-button
        v-show="selectionMode !== 'dates'"
        size="mini"
        type="text"
        class="fei-picker-panel__link-btn"
        @click="changeToNow"
      >
        此刻
      </f-button>
...
export default {
  components: { DateTable, FInput, FButton, TimePickPanel, MonthTable, YearTable },
